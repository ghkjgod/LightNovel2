...
public class NovelItemAdapterUpdate extends RecyclerView.Adapter<NovelItemAdapterUpdate.ViewHolder> {
    ...
    private void refreshAllContent( final ViewHolder viewHolder, int i ) {
        ...
        Uri uri = Uri.parse(Wenku8API.getCoverURL(mDataset.get(i).aid));
...
//            Uri uri = Uri.parse("file://" + GlobalConfig.getFirstStoragePath() + "imgs" + File.separator + mDataset.get(i).aid + ".jpg");
//            viewHolder.ivNovelCover.setImageURI(uri);
...
//            Uri uri = Uri.parse("file://" + GlobalConfig.getSecondStoragePath() + "imgs" + File.separator + mDataset.get(i).aid + ".jpg");
//            viewHolder.ivNovelCover.setImageURI(uri);
//        }else {
