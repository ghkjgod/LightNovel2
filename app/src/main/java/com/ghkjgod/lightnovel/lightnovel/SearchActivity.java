...
import com.ghkjgod.lightnovel.adapter.SearchHistoryAdapter;
...
//        searchContainer = (LinearLayout)findViewById(R.id.search_container);
        ...
        searchClearIcon.setColorFilter(ContextCompat.getColor(this,R.color.mySearchToggleColor), PorterDuff.Mode.SRC_ATOP);
