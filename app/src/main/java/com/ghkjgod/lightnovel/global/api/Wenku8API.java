package com.ghkjgod.lightnovel.global.api;
...
import com.ghkjgod.lightnovel.util.LightBase64;
...
public class Wenku8API {
    ...
    final private static String   NovelFinishedSC = "已完成",
                                    NovelFinishedTC = "已完成",
                                    NovelNotFinishedSC = "连载中",
                                    NovelNotFinishedTC = "連載中";
